...
import 'package:flutter_web_dashboard/pages/regions/widgets/list_of_regions.dart';
...
class RegionPage extends StatefulWidget {
  ...
  RegionPage({Key key, this.regionName, this.showFullData = false})
      : super(key: key);
...
//        height: 400,
  ...
  bool showFullRegionData = false;
  String selectedRegion = MyAppState.currentUser.region ?? "Dar es Salaam";
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<QuerySnapshot>(
        ...
        builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
          ...
          return ChangeNotifierProvider<RegionDataNotifier>(
            create: (_) => RegionDataNotifier(),
            child: Container(
              child: Column(
                children: [
//                  Obx(
                  ...
                  Expanded(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          setState(() {
                            showFullRegionData = !showFullRegionData;
                          });
                        },
                        child: Text(
                          showFullRegionData
                              ? 'Show List of Other Regions'
                              : 'See region\'s full data',
                          style: TextStyle(
                            color: active,
                            fontSize: 20.0,
                          ),
                      ...
                      if (widget.showFullData || showFullRegionData)
