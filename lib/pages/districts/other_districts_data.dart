...
class OtherDistrictsPage extends StatefulWidget {
...
//  }) : super(key: key);
  ...
  @override
  _OtherDistrictsPageState createState() => _OtherDistrictsPageState();
}

class _OtherDistrictsPageState extends State<OtherDistrictsPage> {
  ///
              ...
              child: pw.Expanded(
                child: pw.Column(children: [
                  pw.Padding(
                    ...
                    child: pw.Text(args[0] ?? "Your Districts Data",
                  ...
                  GestureDetector(
                    onTap: () {
                      ...
                      setState(() {
                        ...
                        navigationController.navigateTo(districtsPageRoute);
                      });
                    },
                    child: Row(
                      children: [
...
class OtherDistrictsArguments {
  final String districtName;

  OtherDistrictsArguments({this.districtName});
}
